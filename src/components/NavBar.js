          ...
          <div className="flex h-16 items-center justify-between">
            ...
            >
              ...
              <div className="hidden sm:block">
                <span className="block text-base dark:text-slate-100 font-bold leading-tight text-slate-800">
                  Awash Insurance
                </span>
                ...
                <div ref={userMenuRef} className="relative hidden lg:block">
                  <button
                    ...
                    onClick={() => setUserMenuOpen((o) => !o)}
                            className="flex items-center gap-2.5 rounded-xl py-1.5 pl-1.5 pr-3 dark:hover:ring-slate-700 transition-all hover:bg-sky-50/80"
                  >
                  ...
                  {userMenuOpen && (
                    <>
                      ...
                      <div className="absolute right-0 top-full z-50 mt-2 w-52 overflow-hidden rounded-xl dark:bg-slate-800 border border-sky-100 dark:border-slate-700 bg-white shadow-xl shadow-sky-100/30 ring-1 ring-black/5">
                        <div className="border-b border-sky-50 bg-gradient-to-r from-sky-50 to-blue-50 px-4 py-3 dark:border-slate-700">
