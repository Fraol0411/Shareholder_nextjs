                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center gap-2 rounded-full px-3.5 py-2 text-[13px] font-semibold transition-all ${
                        active ? 'bg-blue-600 text-white shadow-md shadow-blue-200' : 'text-slate-500 hover:bg-blue-50 hover:text-blue-600'
                      }`}
                    >
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              {user && (
                <div ref={userMenuRef} className="relative flex items-center">
                  ...
                  >
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-[11px] font-bold text-white shadow-sm shrink-0">
             ...
             {navItems.map(({ href, label, icon: Icon }) => (
                <Link
                  ...
                  className={`flex items-center gap-3 p-4 rounded-2xl text-sm font-semibold ${
                    isActive(href) ? 'bg-blue-600 text-white' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50'
                  }`}
                >
