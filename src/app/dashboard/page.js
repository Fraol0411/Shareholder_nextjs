...
export default function ShareholderDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header - Made sticky with sticky top-0 z-50 */}
      <header className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div  className="flex items-center space-x-6">
            ...
            >
              <FaSignOutAlt className="mr-1" /> ውጣ
            </button>
          </div>
        </div>
      </header>
      ...
      <footer className="bg-white border-t border-gray-200 mt-12 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm text-gray-600">© {new Date().getFullYear()} አዋሽ ኢንሹራንስ. ሁሉም መብቶች የተጠበቁ ናቸው.</p>
        </div>
      </footer>
    </div>
  );
